...
let items = [
    ...
    { name: 'available-duty-day', allocationType: 'Local', shiftType: 'Duty Day' },
    ...
    { name: 'available-standby-day', allocationType: 'Local', travel: true, shiftType: 'STBY' },
    ...
    { name: 'available-off-day', allocationType: 'Local', shiftType: 'Day Off' },
